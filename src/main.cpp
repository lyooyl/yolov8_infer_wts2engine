...
void Inference(std::string& engine_name, std::string& class_file, std::string& video_file) {
    ...
    //image = cv::imread("../images/bus.jpg");
...
int main(int argc, const char* argv[]) {
    std::cout << __FILE__ << "::" << __func__ << "::" << __LINE__ << "::" << "argc == " << argc << std::endl;

    
    //// ************** 生成engine ************** //
    //std::string wts_name = "D:/Work/10_yolov8/yolov8_tensorrt-main/weights/yolov8n.wts";
    //// wts_name = "";  // 注释掉为生成engine
    //std::string engine_name = "D:/Work/10_yolov8/yolov8_tensorrt-main/weights/yolov8n.engine";
    //std::string class_file = "D:/Work/10_yolov8/yolov8_tensorrt--main/weights/classes80.txt";
    //std::string sub_type = "n";
    ...
    std::string class_file = argv[2];
    std::string sub_type = argv[3];
    ...
    Inference(engine_name, class_file, video_file);
